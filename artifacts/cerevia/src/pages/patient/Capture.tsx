...
export default function Capture() {
  ...
  function stopRecording() {
    ...
    setTranscript('Dr. Chen asked about frequency of headaches over the past month. I mentioned they have been improving since reducing screen time. She suggested we continue the current Topiramate dose and review in six weeks. She also wants me to keep a trigger diary.')
  }
    ...
    <div className="px-5 py-4 space-y-5">
      ...
      <div className="flex flex-col items-center gap-6 py-8">
        <motion.button
          ...
          style={{ background: recording ? 'rgba(192,82,106,0.15)' : 'rgba(104,184,175,0.15)', border: `3px solid ${recording ? '#C0526A' : '#68B8AF'}`, cursor: 'pointer' }}
          whileTap={{ scale: 0.92 }}
        >
          {recording
        ...
        {recording ? (
          <div className="text-center space-y-1">
            <div className="flex items-center gap-2 justify-center">
              <div className="w-2 h-2 rounded-full bg-[#C0526A]" />
      ...
      <AnimatePresence>
        {transcript && (
          ...
          >
            ...
            <button className="flex items-center gap-2 px-4 py-2 rounded-full border text-sm font-semibold"
              style={{ fontFamily: 'Nunito, sans-serif', borderColor: '#68B8AF', color: '#68B8AF', background: 'transparent', cursor: 'pointer' }}>
