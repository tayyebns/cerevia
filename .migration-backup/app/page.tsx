...
const ModelViewer = dynamic(
  () => import('@/components/ModelViewer').then((m) => m.ModelViewer),
  {
    ssr: false,
    loading: () => (
      <div style={{ width: '100%', height: 420, background: 'rgba(104,184,175,0.05)', borderRadius: 28 }} />
    ),
  }
)
    ...
    <div className="min-h-screen flex flex-col" style={{ background: 'var(--bg)' }}>
      ...
      <main className="flex-1 flex items-center px-6 py-12 max-w-6xl mx-auto w-full">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center w-full">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link href="/auth/signup" style={{ textDecoration: 'none' }}>
                ...
                >
                  ...
                  <div>
                    ...
                    >
                      Track symptoms and medication
                    </div>
                  </div>
                  <div
                    className="flex items-center gap-1"
                    style={{ color: '#68B8AF', fontFamily: 'Nunito, sans-serif', fontSize: 13, fontWeight: 600 }}
                  >
              ...
              <Link href="/auth/signup" style={{ textDecoration: 'none' }}>
                <motion.div
                  ...
                  className="flex flex-col items-start gap-3 p-5 rounded-[28px] cursor-pointer"
                  style={{
                    background: 'linear-gradient(135deg, #1E433E, #132B28)',
                    border: '1.5px solid #265750',
                    boxShadow: '0 4px 24px rgba(15,22,21,0.28)',
                    minWidth: 200,
                  }}
                >
                  <div
                    className="w-11 h-11 rounded-2xl flex items-center justify-center"
                    style={{
                      background: 'rgba(104,184,175,0.2)',
                      border: '1px solid rgba(104,184,175,0.3)',
                    }}
                  >
            ...
            <div className="flex flex-wrap gap-5 pt-1">
              {[
                ...
                <div
                  ...
                  style={{ fontFamily: 'Nunito, sans-serif', fontSize: 13, color: 'var(--text-subtle)' }}
                >
          ...
          {/* Right: 3D model — always dark, adapts glow to theme */}
          <motion.div
            initial={{ opacity: 0, y: 24 }}
            animate={{ opacity: 1, y: 0 }}
            ...
            style={{
              background: 'linear-gradient(160deg, var(--model-from), var(--model-to))',
              border: '1px solid rgba(104,184,175,0.18)',
              boxShadow: '0 8px 40px rgba(15,22,21,0.28)',
              minHeight: 420,
            }}
          >
            <div
              ...
              style={{
                background: 'radial-gradient(ellipse at 50% 60%, var(--model-glow) 0%, transparent 70%)',
              }}
            />
            <ModelViewer />
          </motion.div>
