...
// Tick mark positions (clock-face angles)
  ...
  return (
    <AnimatePresence>
      {visible === true && (
        ...
        >
          {/* Deep radial glow — static, no pulse */}
          <div
            style={{
              position: 'absolute',
              inset: 0,
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 0 }}>
            ...
            <div style={{ position: 'relative', width: 140, height: 140 }}>
              <svg width="140" height="140" viewBox="0 0 140 140" style={{ overflow: 'visible' }}>
                {/* Faint static background ring */}
                <circle
                  cx="70" cy="70" r="62"
                  fill="none"
                  stroke="rgba(104,184,175,0.06)"
                  strokeWidth="1"
                />
                ...
                {/* Inner ring that fades in after trace */}
                <motion.circle
                  cx="70" cy="70" r="46"
                  fill="none"
                ...
                {/* Dot at top of circle (12 o'clock) */}
                <motion.circle
                  cx="70" cy="16"
                  r="3"
                  fill="#68B8AF"
              ...
              >
                <Brain
                  strokeWidth={1}
                  style={{ width: 36, height: 36, color: '#68B8AF' }}
                />
              </motion.div>
            </div>

            {/* Wordmark — letter-spacing contracts as it fades in */}
            <motion.div
            ...
            {/* Gradient underline that draws left to right */}
